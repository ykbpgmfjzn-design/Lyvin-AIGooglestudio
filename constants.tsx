...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    id: 'goal',
    question: 'Для каких целей вы рассматриваете недвижимость на Бали?',
    options: ['Инвестиции (пассивный доход)', 'Для жизни и отдыха', 'Смешанная стратегия']
  },
  {
    id: 'budget',
    question: 'Инвестиционный бюджет:',
    options: ['до $300 тыс.', '$300 тыс. – $500 тыс.', '$500 тыс. – $1 000 000', 'более $1 000 000']
  },
  {
    id: 'stage',
    question: 'На какой стадии строительства?',
    options: ['на этапе котлована', 'готовность в течение года', 'готовые проекты']
  },
  {
    id: 'timeline',
  ...
  {
    id: 'location',
    question: 'Вы сейчас на Бали?',
    options: ['Да', 'Нет, но планирую прилететь', 'Нет']
  }
];
